...
df = spark.read.table('monitoring_consumption_countries_hourly')
...
df_hourly.write.format('delta').mode('overwrite').saveAsTable('final_monitoring_consumption_countries_hourly')
